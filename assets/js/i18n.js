...
(function () {
  var STRINGS = {
    en: {
      ...
      'prop.spaceBefore': 'Space before',
      'prop.spaceAfter': 'Space after',
      'prop.indent': 'First line',
      'prop.highlight': 'Highlight',
      'prop.underline': 'Underline',
      'prop.underlineLetter': 'U',
      'prop.effects': 'Effects',
      'prop.textShadow': 'Text shadow',
      'prop.textShadowColour': 'Text shadow colour',
      'prop.wholeBox': 'Styling the whole box. Select words while editing to style only those.',
      'prop.someLetters': {
        one: 'Styling the {n} selected character.',
        other: 'Styling the {n} selected characters.',
      },
      'prop.box': 'Box',
    ...
    lv: {
      ...
      'prop.paragraph': 'Rindkopa',
      'prop.spaceBefore': 'Atstarpe pirms',
      'prop.spaceAfter': 'Atstarpe pēc',
      'prop.indent': 'Pirmā rinda',
      'prop.highlight': 'Izcēlums',
      'prop.underline': 'Pasvītrojums',
      'prop.underlineLetter': 'P',
      'prop.effects': 'Efekti',
      'prop.textShadow': 'Teksta ēna',
      'prop.textShadowColour': 'Teksta ēnas krāsa',
      'prop.wholeBox': 'Noformē visu lauku. Rediģējot atlasiet vārdus, lai noformētu tikai tos.',
      'prop.someLetters': {
        zero: 'Noformē {n} atlasītās rakstzīmes.',
        one: 'Noformē {n} atlasīto rakstzīmi.',
        other: 'Noformē {n} atlasītās rakstzīmes.',
      },
      'prop.box': 'Kaste',
    ...
    ru: {
      ...
      'prop.paragraph': 'Абзац',
      'prop.spaceBefore': 'Отступ сверху',
      'prop.spaceAfter': 'Отступ снизу',
      'prop.indent': 'Первая строка',
      'prop.highlight': 'Выделение',
      'prop.underline': 'Подчёркивание',
      'prop.underlineLetter': 'П',
      'prop.effects': 'Эффекты',
      'prop.textShadow': 'Тень текста',
      'prop.textShadowColour': 'Цвет тени текста',
      'prop.wholeBox': 'Оформляется всё поле. Выделите слова при правке, чтобы оформить только их.',
      'prop.someLetters': {
        one: 'Оформляется {n} выбранный символ.',
        few: 'Оформляется {n} выбранных символа.',
        many: 'Оформляется {n} выбранных символов.',
        other: 'Оформляется {n} выбранных символа.',
      },
      'prop.box': 'Блок',
      'prop.background': 'Фон',
      'prop.border': 'Рамка',
